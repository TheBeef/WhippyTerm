...
{
    "Basic Control Charactors",
    "Basic ASCII control charactors like new line, backspace, and cartridge return",
 ...
 *
 * SYNOPSIS:
 *    void BasicCtrlCharsDecoder_RegisterPlugin(
 *              const struct PI_SystemAPI *SysAPI);
 *
 * PARAMETERS:
 *    SysAPI [I] -- The main system API
 *
 * FUNCTION:
