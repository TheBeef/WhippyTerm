...
bool Settings_RegisterKeyValueType(class TinyCFG &cfg,
        const char *XmlName,t_KVList *Data)
{
...
///////////////////
class PluginSettingsList : public TinyCFGBaseData
{
    public:
        t_PluginSettings *Ptr;
        bool LoadElement(class TinyCFG *CFG);
        bool SaveElement(class TinyCFG *CFG);
};
bool PluginSettingsList::LoadElement(class TinyCFG *CFG)
{
    struct PluginSettings NewData;
...
bool PluginSettingsList::SaveElement(class TinyCFG *CFG)
{
    i_PluginSettings i;
    class TinyCFG SubCFG("Plugin");
    struct PluginSettings NewData;
...
bool RegisterPluginSettingsList(class TinyCFG &cfg,const char *XmlName,
        t_PluginSettings &Data)
{
    class PluginSettingsList *NewDataClass;

    /* Make a new class to handle this new piece of data */
    try
    {
        NewDataClass=new PluginSettingsList;
    }
    catch(std::bad_alloc &)
    {
        return false;
...
{
    cfg.Register("IDStr",IDStr);
    Settings_RegisterKeyValueType(cfg,"Settings",&Settings);
}
