...
static struct ReleaseNote m_Notes_NEXT[]=
{
    {   NOTETYPE_NEW_FEATURE,"The bottom hex dump panels now support the same bytes per line/divider lines as binary mode",
            ...
            " Settings->Panels->Hex Display->Hex Dumps"},
...
static struct ReleaseNote m_Notes_Rel2_3_0_0[]=
{
    ...
    {   NOTETYPE_BUG_FIX,"Font rendering doesn't lineup with mouse clicks",
            ...
            " hopefully fix this."},
    {   NOTETYPE_BUG_FIX,"Fixed sounds not playing.",
            "The sound playing system stoped working when moving to QT6."
            " It's been reworked to work again."},
};
...
static struct ReleaseNote m_Notes_Rel2_2_0_0[]=
{
    ...
    {
        NOTETYPE_NEW_FEATURE,"Updated Binary HexDump to support Binary Protocol Description Standard strings",
